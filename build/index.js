...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Websocket = (function (_React$Component) {
	  ...
	  function Websocket(props) {
	    ...
	    this.state = {
	      ws: window.WebSocket ? new window.WebSocket(this.props.url, this.props.protocols) : new window.MozWebSocket(this.props.url, this.props.protocols),
	      attempts: 1
	    };
	      ...
	      websocket.onclose = function (evt) {
	        ...
	        if (_this.shouldReconnect) {
	          ...
	          _this.timeoutID = setTimeout(function () {
	            ...
	            _this.setState({
	              ws: window.WebSocket ? new window.WebSocket(_this.props.url, _this.props.protocols) : new window.MozWebSocket(_this.props.url, _this.props.protocols)
	            });
	...
	Websocket.propTypes = {
	  ...
	  protocols: _propTypes2['default'].arrayOf(_propTypes2['default'].string),
